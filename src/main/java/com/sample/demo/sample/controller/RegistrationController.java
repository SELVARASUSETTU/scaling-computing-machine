package com.sample.demo.sample.controller;

import com.sample.demo.sample.model.Users;
import com.sample.demo.sample.repository.UserJpaRepository;
...
public class RegistrationController {
    private final UserJpaRepository userService;

    @Autowired
    private JavaMailSender mailSender;

    public RegistrationController(UserJpaRepository userService) {
